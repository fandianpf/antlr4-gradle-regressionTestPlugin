...
class Antlr4TestPluginTest {
    ...
    void pluginIsApplied() {
        ...
        assert args.contains('-primaryIndent')
        assert args.contains('. ')
        assert args.contains('-secondaryIndent')
        assert args.contains(', ')
        assert args.contains('-indentCycle')
        assert args.contains(5)
        assert args.contains('-metrics')
        assert args.contains(testProject.file('metricsTable.csv').getAbsolutePath())
